  ...
  return (
    <div className="items-stretch flex gap-0 mt-16 self-start max-md:max-w-full max-md:flex-wrap max-md:mt-10">
      <span className="items-stretch flex gap-0">
        ...
        <button className="text-zinc-500 text-center text-lg font-medium self-center grow whitespace-nowrap my-auto">
          Flashcard
        </button>  
      </span>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 20" fill="none">
        ...
        <button className="text-zinc-500 text-center text-lg font-medium">
          Mathematics
        </button>
        ...
        <path d="M8.59003 16.59L13.17 12L8.59003 7.41L10 6L16 12L10 18L8.59003 16.59Z" fill="#06286E"/>
          ...
          <button className="text-blue-950 text-center text-lg font-semibold grow whitespace-nowrap self-start">
